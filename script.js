(function () {
  ...
  if (isFine && cursor && ring) {
    ...
    // Magnetic snap on [data-magnetic] elements
  ...
  gsap.from('.hero-meta', { opacity: 0, y: 15, duration: 0.8, delay: 1, ease: 'power2.out' });

  // Hero parallax — image shifts slower
  gsap.to('.hero-img-wrap img', {
    scale: 1.0, y: -60, ease: 'none',
    scrollTrigger: { trigger: '.hero', start: 'top top', end: 'bottom top', scrub: 1.5 }
  });

  // ---------- ALL TEXT MASK REVEALS ----------
